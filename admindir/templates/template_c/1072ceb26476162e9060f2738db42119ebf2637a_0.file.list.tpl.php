...
.html" target="_blank" title="Xem nhanh">
                              ...
                              <?php }?>
                              <a class="act-btn btnEdit" title="Chỉnh sửa" href="index.php?do=articlelist&act=edit&id=<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
&comp=<?php echo $_REQUEST['comp'];?>
">
                                 <i class="fa fa-edit"></i>
                              </a>
                              <button class="act-btn btnUpdateNum" title="Làm mới" data-id="<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" data-comp="<?php echo $_REQUEST['comp'];?>
">
                                 <i class="fa fa-refresh"></i>
                              </button>
                              <button class="act-btn btnDeleteRow" title="Xoá" data-id="<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" data-comp="<?php echo $_REQUEST['comp'];?>
">
