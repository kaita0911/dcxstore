<?php
/* Smarty version 4.3.1, created on 2025-10-22 05:46:37
  from 'D:\htdocs\dcxstore\admindir\templates\tpl\menu\edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_68f8539d973737_30993855',
...
function content_68f8539d973737_30993855 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="<?php if ($_smarty_tpl->tpl_vars['lang']->value['id'] == 1) {?>active<?php }?>">
                     <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['lang']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
">
                     <div class="item">
                        ...
                        <div class="info-title">
                           <input type="text"
                              name="name_<?php echo $_smarty_tpl->tpl_vars['lang']->value['id'];?>
"
                              id="title_<?php echo $_smarty_tpl->tpl_vars['lang']->value['id'];?>
"
                              class="InputText title-input"
                              value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->tpl_vars['menuDetail']->value[$_smarty_tpl->tpl_vars['lang']->value['id']]['name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                     </div>
...
"
                              id="slug_<?php echo $_smarty_tpl->tpl_vars['lang']->value['id'];?>
"
                              class="InputText slug-input"
                              value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->tpl_vars['menuDetail']->value[$_smarty_tpl->tpl_vars['lang']->value['id']]['unique_key'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                     </div>
                  </div>
