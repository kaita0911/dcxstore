               ...
               <div class="wrap-main">
                  <div class="left100">
                     ...
                     <div class="item">
                        ...
                        <div class="info-title">
                           <input type="text" name="name" id="title" class="InputText title-input"
                              value="{$categoryDetail.name|escape:'html':'UTF-8'}" />
                        </div>
                     </div>
                     ...
                     <div class="item">
                        ...
                        <div class="meta">
                           <textarea id="editor" name="content">{$categoryDetail.content}</textarea>
                        </div>
                     </div>
                     ...
                     <div class="item">
                        ...
                        <div class="meta">
                           <input name="keyword" value="{$categoryDetail.keyword}" data-role="tagsinput" class="InputText">
                        </div>
                     </div>
                     ...
                     <div class="item">
                        ...
                        <div class="meta">
                           <textarea name="des" class="InputTextarea" id="inputDesc">{$categoryDetail.des}</textarea>
