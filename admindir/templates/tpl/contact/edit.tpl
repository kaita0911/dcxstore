      ...
      <div class="right_content conten">
         <div class="main-content">
            ...
            <div class="item">
               ...
               <div class="meta">
                  <textarea class="InputTextarea"><!--{$edit.message}--></textarea>
               </div>
            </div>
            <p class="slss"><a href="index.php?do=contact&comp=23" title="Trở về"><i class="fa fa-rotate-left"></i> Trở về</a></p>
         </div>
