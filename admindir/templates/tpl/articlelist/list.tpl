                     ...
                     <tbody>
                        ...
                        <tr data-id="{$item.id}">
                           ...
                           <td align="left" class="main-tabs">
                              ...
                              {assign var="detail" value=$item.details[$lang.id]}
                              <span class="c-name editable-name {if $lang.id == 1}active{/if} tab-pane" data-id="{$item.id}"
                                 data-lang="{$lang.id}" data-tab="tab_{$lang.id}">
                                 <span class="view-text">{$detail.name|escape:'html':'UTF-8'}</span>
                                 <input type="text" class="edit-input form-control" value="{$detail.name|escape:'html':'UTF-8'}" style="display:none;">
                              </span>
                              {/foreach}
                           </td>
