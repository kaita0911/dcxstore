          ...
          <div class="tab-content">
            <div class="wrap-main">
              <div class="left100 main-tabs">
                ...
                <div class="tab-pane {if $lang.id == 1}active{/if}" data-tab="tab_{$lang.id}">
                  <div class="item">
                    ...
                    <div class="info-title">
                      <input type="text" name="name_{$lang.id}" id="title_{$lang.id}"
                        value="{$articlelistDetail[$lang.id].name|escape:'html':'UTF-8'}"
                  ...
                  <div class="item">
                    ...
                    <div class="info-title">
                      <input type="text" id="slug_{$lang.id}" name="unique_key_{$lang.id}" value="{$articlelistDetail[$lang.id].unique_key}" class="InputText slug-input" />
                    </div>
                  </div>
                  {if $tinhnang.short == 1}
                  <div class="item">
                    ...
                    <div class="meta">
                      <textarea id="short{$lang.id}" name="short_{$lang.id}">{$articlelistDetail[$lang.id].short}</textarea>
                    </div>
                  </div>
                  {/if}
                  ...
                  <div class="item">
                    ...
                    <div class="meta">
                      <textarea id="editor{$lang.id}" name="content_{$lang.id}">{$articlelistDetail[$lang.id].content}</textarea>
                    </div>
                  </div>
                  {/if}
                  ...
                  <div class="item">
                    ...
                    <div class="meta">
                      <input name="keyword_{$lang.id}" value="{$articlelistDetail[$lang.id].keyword}" data-role="tagsinput" class="InputText" />
                    </div>
                  </div>
                  <div class="item">
                    <div class="title">Meta Descriptions</div>
                    <div class="meta">
                      <textarea name="des_{$lang.id}" class="InputTextarea" id="inputDesc">{$articlelistDetail[$lang.id].des}</textarea>
              ...
              <div class="right100">
                ...
                {* <div class="item">
                  <div class="title">
                    <input id="togglePrice" type="checkbox" class="CheckBox" name="mostview" value="mostview" {if $articlelist.mostview==1}checked{/if} /> Phân giá theo loại
                  </div>
                  <div class="box-more" id="box-size-more">
                    <div class="title">Nhập khoảng giá</div>
                    <div class="distance-price">
                      <input type="text" name="price-min" class="InputPrice autoNumeric" value="{$articlelist.price_min}" />
                      <span>-</span>
                      <input type="text" name="price-max" class="InputPrice autoNumeric" value="{$articlelist.price_max}" />
                    </div>
                    <div class="selectlist list-size">
                      {insert name="listmoresize" idpr=$articlelist.id idcomp=$articlelist.comp}
                      <div class="addInput" onclick="addTwoInputs()">Thêm loại và giá</div>
                      <input type="hidden" id="count-size-edit" name="countsize_edit" value="">
                    </div>
                  </div>
                </div> *}
                {/if}
