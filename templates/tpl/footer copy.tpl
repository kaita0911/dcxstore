    ...
    <div class="row">
      ...
      <div class="fanpage col-md-4 col-ms-4 col-xs-12">
        <div class="contactfirst">
          <h2>FANPAGE</h2>
          <div id="fb-root"></div>
          <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v23.0&appId=262496960768696"></script>
          <div class="fb-page"
            data-href="https://www.facebook.com/Dichungxetapluyenleonuimoituan/"
            data-tabs=""
            data-width=""
            data-height=""
            ...
            <blockquote cite="https://www.facebook.com/Dichungxetapluyenleonuimoituan/" class="fb-xfbml-parse-ignore">
              <a href="https://www.facebook.com/Dichungxetapluyenleonuimoituan/">Đi chung xe - Tập luyện leo núi mỗi tuần</a>
            </blockquote>
          </div>
        </div>
      </div>
